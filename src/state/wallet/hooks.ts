import { RUG } from './../../constants/index'
import { Currency, CurrencyAmount, CAVAX, JSBI, Token, TokenAmount } from '@rugenerous/sdk'
...
// get the total owned and unharvested RUG for account
export function useAggregateRugBalance(): TokenAmount | undefined {
