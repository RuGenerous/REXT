...
import { useGovernanceContract, useRugContract } from '../../hooks/useContract'
...
import { abi as GOV_ABI } from '@rugenerous/governance/artifacts/contracts/GovernorAlpha.sol/GovernorAlpha.json'
...
export function useUserDelegatee(): string {
  ...
  const uniContract = useRugContract()
