...
import { JSBI, Percent, Router, SwapParameters, Trade, TradeType } from '@rugenerous/sdk'
                ...
                return contract.callStatic[methodName](...args, options)
                  ...
                  .catch(callError => {
                    ...
                    switch (callError.reason) {
                      case 'RugenerousRouter: INSUFFICIENT_OUTPUT_AMOUNT':
                      case 'RugenerousRouter: EXCESSIVE_INPUT_AMOUNT':
                        errorMessage =
