import { ChainId, JSBI, Percent, Token, WAVAX } from '@rugenerous/sdk'
...
export const ANALYTICS_PAGE = 'https://info.ruggy.exchange/'
...
const WAVAX_AND_RUG_ONLY: ChainTokenList = {
  [ChainId.FUJI]: [WAVAX[ChainId.FUJI], RUG[ChainId.FUJI]],
  [ChainId.AVALANCHE]: [WAVAX[ChainId.AVALANCHE], RUG[ChainId.AVALANCHE]]
}
...
export const TRUSTED_TOKEN_ADDRESSES: { readonly [chainId in ChainId]: string[] } = {
  [ChainId.FUJI]: [],
  [ChainId.AVALANCHE]: [WAVAX[ChainId.AVALANCHE].address, RUG[ChainId.AVALANCHE].address]
}
